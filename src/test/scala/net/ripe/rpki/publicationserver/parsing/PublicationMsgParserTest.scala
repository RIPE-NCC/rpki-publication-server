...
class PublicationMsgParserTest extends PublicationServerBaseTest {
  ...
  test("should parse publish message") {
    ...
    val msg = msgParser.parse(publishXml).toOption.get.asInstanceOf[QueryMessage]
  ...
  test("should parse withdraw message") {
    ...
    val msg = msgParser.parse(withdrawXml).toOption.get.asInstanceOf[QueryMessage]
  ...
  test("should parse list message") {
    ...
    val msg = msgParser.parse(listXml).toOption.get
